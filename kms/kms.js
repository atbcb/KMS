...

{
   "guide": [
      ...
      },
      {
         ...
         "content": "Recommendation:  Automation of exterior doors is recommended, especially where the opening force is likely to be significant.  Otherwise, closers should be calibrated with the least force necessary for closure to minimize the opening force.  Difficulty opening manual entrance doors is a common access complaint.",
         "imageFile": [],
         "imageAlt": []
      },
      {
   ...
   "FAQ": [
      ...
      },
      {
         ...
         "answer": "No, the Standards limit the rise of each run (30\" max.), but not the overall length of ramps comprised of multiple runs. Since the usability of ramps decreases with length, considerably long ramp systems should be avoided where possible. (Ramps in play areas are limited to a 12\" max. rise).",
         "imageFile": [],
         "imageAlt": []
      },
      {
   ...
   "clarification": [
      ...
      },
      {
         ...
         "answer": "The maximum 1:48 slope is measured in two directions only (running and cross slopes).",
         "imageFile": [],
         "imageAlt": []
      },
      {
